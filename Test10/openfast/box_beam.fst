...
---------------------- INPUT FILES ---------------------------------------------
"box_beam_ElastoDyn.dat"   EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"../beamdyn/Box_Beam_SCALED_2_BeamDyn.dat"     BDBldFile(1) - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"../beamdyn/Box_Beam_SCALED_2_BeamDyn.dat"     BDBldFile(2) - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"../beamdyn/Box_Beam_SCALED_2_BeamDyn.dat"     BDBldFile(3) - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
