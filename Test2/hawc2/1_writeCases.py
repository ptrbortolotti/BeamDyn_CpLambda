...
simDir='cases'
HAWC2='hawc2'
BD_mainfile    = '../bd_static_load_conv_new/f_1.5e6/solid_beam_BeamDyn.dat'
BD_bladefile   = '../bd_static_load_conv_new/f_1.5e6/solid_beam_BeamDyn_Blade.dat'
BD_bladefile   = '../../Test1/bd_static_load_conv/solid_beam_BeamDyn_Blade.dat'
H2_htcfile_old = './template.htc'
H2_htcfile_new = os.path.join(simDir,'default.htc')
H2_stfile      = os.path.join(simDir,'solid_beam_st.st')
vf = [2e5,5e5,1e6,1.5e6,2e6,4e6,5e6,8e6,1e7]
